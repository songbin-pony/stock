  ...
  export default {
    ...
    methods: {
      dialogConfirmed_2() {
        ...
        _this.$http({
          method: 'post',
          url: "http://localhost:8000/banner/addbanner/",
          data: _this.$qs.stringify({params_1: _this.newImgForm.description, params_2: _this.newImgForm.link}),
          headers: {
      ...
      dialogConfirmed_1() {
        ...
        this.$http({
          method: 'post',
          url: "http://localhost:8000/banner/updatebanner/",
          data: _this.$qs.stringify({params_1:_this.reSetForm.id,params_2: _this.reSetForm.description, params_3: _this.reSetForm.link}),
          headers: {
            'Content-Type': 'application/x-www-form-urlencoded'
          }
        }).then(function (res) {
      ...
      handleDelete(index, id) {
        ...
        this.$http({
          method: 'post',
          url: "http://localhost:8000/banner/deletebanner/",
      ...
      handleReset(index, id) {
        ...
        this.$http({
          method: 'post',
          url: "http://localhost:8000/banner/findbannerbyid/",
          data: _this.$qs.stringify({params_1:id}),
          headers: {
            'Content-Type': 'application/x-www-form-urlencoded'
          }
