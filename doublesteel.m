...
%************************************************
%     figure(1)
%     Picture=imread('截面参数示意图.png');
%     imshow(Picture);
%     title('the diagram of the section','visible','on','color','b');
%     disp('请按照示意截面输入截面形状的基本控制参数！')
%截面形状的基本控制参数
% B=500;B1=255;B2=250;B3=250;H1=80;H2=1;H3=220;H4=1;H5=300;
% B=input('请输入宽度B（mm）（例如2500）：');
% B1=input('请输入宽度B1（mm）（例如1900）：');
% B2=input('请输入宽度B2（mm）（例如300）：');
% B3=input('请输入宽度B3（mm）（例如600）：');
% H1=input('请输入高度H1（mm）（例如250）：');
% H2=input('请输入高度H2（mm）（例如250）：');
% H3=input('请输入高度H3（mm）（例如1050）：');
% H4=input('请输入高度H4（mm）（例如150）：');
% H5=input('请输入高度H5（mm）（例如300）：');
width=300;height=450;%单位mm
...
% steeltype=input('请输入钢筋类型（1-HPB235 2-HRB335 3-HRB400 4-RRB400）（例如HRB335钢筋请输入2）：');%钢筋抗拉强度
